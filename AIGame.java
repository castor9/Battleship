...
public class AIGame {
	...
	*
	*	@param playerOne type of player in game
	*	@param playerTwo type of player in game
	*	@param rows number of rows in the game
	*	@param columns number of columns in game
	*	@param name name of player One
	*	@param opponentName name of opponent
	*
	*/
	public AIGame(Player playerOne, Player playerTwo, int rows, int columns, String name, String opponentName) {
		GUIBoard boardYouPlayOn = new GUIBoard(name + ": You",rows,columns,600,0,450,450, 1);
		GUIBoard oppPlaysThis = new GUIBoard(opponentName, rows,columns,0,0,450,450, 0);

		GUIBoard hisHiddenBoard = new GUIBoard("AI: small board",rows,columns,600,600,0,0, 0);
		GUIBoard yourHiddenBoard = new GUIBoard("You: Small board", rows, columns,0,600,0,0, 1);
